...
static const char *fonts[]    = { "Cantarell:style=Regular:size=10:antialias=true:autohint=true", "FontAwesome:style=Regular:size=10:antialias=true:autohint=true", "Font awesome 5 Free Solid:style=Solid:size=10:antialias=true:autohint=true" };
